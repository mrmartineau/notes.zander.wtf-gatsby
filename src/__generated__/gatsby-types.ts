...
export type AllPagesFragment = (
  Pick<Mdx, 'id'>
  & { readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'title' | 'tags' | 'emoji'>>, readonly fields: Maybe<Pick<MdxFields, 'dateModified'>>, readonly parent: Maybe<Pick<File, 'name'>> }
);

export type Unnamed_1_QueryVariables = {};


export type Unnamed_1_Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: AllPagesFragment }> } };
...
export type Unnamed_2_Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id'>
        & AllPagesFragment
      ) }> } };
...
export type Unnamed_3_Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id'>
        & AllPagesFragment
      ) }> } };
...
export type Unnamed_4_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

export type Unnamed_5_QueryVariables = {};


export type Unnamed_5_Query = { readonly allMdx: { readonly tags: ReadonlyArray<(
